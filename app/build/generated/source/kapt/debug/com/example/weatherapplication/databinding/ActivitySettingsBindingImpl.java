...
public class ActivitySettingsBindingImpl extends ActivitySettingsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.radioGroupp, 3);
        sViewsWithIds.put(R.id.togge_degree_celsiuss, 4);
        sViewsWithIds.put(R.id.toggel_Kelvinn, 5);
        sViewsWithIds.put(R.id.toggel_Fahrenheitt, 6);
    }
    // views
    @NonNull
