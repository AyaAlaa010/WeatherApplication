...
class Map2 : AppCompatActivity(), OnMapReadyCallback ,View.OnClickListener{
    ...
    private fun geoLocate() {
        ...
        if (list.size > 0) {
            ...
            val sharedPreferences: SharedPreferences = getSharedPreferences("MapLocation", Context.MODE_PRIVATE)
            val editor: SharedPreferences.Editor =  sharedPreferences.edit()
            editor.putFloat("latMap",address.latitude.toFloat() )
            editor.putFloat("lonMap",address.longitude.toFloat() )
            editor.apply()
            editor.commit()
    ...
    private fun moveCamera(latLng: LatLng, zoom: Float, title: String) {
      ...
      //  model.langitude=latLng.longitude
    ...
    private fun initMap() {
        ...
        mapFragment!!.getMapAsync(this@Map2)
    }
    ...
    override fun onClick(view: View?) {
        if(view?.id  == R.id.bt_map_confirm) {
            ...
            if(StreetDateClass(this).mapDifferentActivity()==2){
                ...
                var searchLat = sharedPreferences.getFloat("latMap",0.0f)
                var searchLon=sharedPreferences.getFloat("lonMap",0.0f)
